        ...
        <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
          ...
          <form onSubmit={loginForm.handleSubmit} className="mx-auto max-w-lg rounded-lg border">
            <div className="bg-white flex flex-col gap-4 p-4 md:p-8">
              ...
              <button className="block rounded-lg bg-blue-500 px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-gray-300 transition duration-100 hover:bg-blue-700 focus-visible:ring active:bg-gray-600 md:text-base">
                Log in
              </button>
